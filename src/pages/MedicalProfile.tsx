...
export default function MedicalProfilePage() {
  ...
  if (loading) {
    return (
      <div className="dark min-h-screen bg-[#0C0B08] flex items-center justify-center">
  ...
  return (
    <div className="dark min-h-screen bg-[#0C0B08] text-white relative">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-5">
        <div className="rounded-2xl border border-[#D4AF37]/15 bg-gradient-to-b from-[#D4AF37]/[0.06] to-transparent p-5">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-1.5">
            <Label className="flex items-center gap-2 text-xs text-white/50">
              <Droplets className="h-3.5 w-3.5 text-[#D4AF37]" /> Tipo sanguíneo
            </Label>
          ...
          <div className="space-y-1.5">
            <Label className="flex items-center gap-2 text-xs text-white/50">
              <Bandage className="h-3.5 w-3.5 text-[#D4AF37]" /> Alergias
            </Label>
            <Textarea
          ...
          <div className="space-y-1.5">
            <Label className="flex items-center gap-2 text-xs text-white/50">
              <Pill className="h-3.5 w-3.5 text-[#D4AF37]" /> Medicação em curso
            </Label>
            <Textarea
          ...
          <div className="space-y-1.5">
            <Label className="flex items-center gap-2 text-xs text-white/50">
              <FileText className="h-3.5 w-3.5 text-[#D4AF37]" /> Condições médicas e notas
            </Label>
            <Textarea
...
function MedicalRow({ icon: Icon, label, value }: { icon: any; label: string; value: string | null }) {
  ...
  return (
    <div className="flex items-start gap-2.5 text-xs">
      <Icon className="h-3.5 w-3.5 text-[#D4AF37] shrink-0 mt-0.5" />
