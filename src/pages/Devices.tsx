...
export default function Devices() {
  ...
  const stats = useMemo(() => [
    ...
    { label: 'Conectados', value: devicesWithBLE.filter((d) => d.bleConnected).length, icon: BluetoothConnected, color: 'text-[#25D366]' },
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <Badge variant="outline" className={cn(
            ...
            bleAvailable ? 'border-[#25D366]/30 text-[#25D366]' : 'border-red-500/30 text-red-400'
          )}>
            ...
            <SpotlightCard className="p-6">
                  ...
                  {bleScanning && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center justify-center gap-3 mt-3">
                      <div className="relative">
                        <div className="w-3 h-3 rounded-full bg-[#25D366] animate-ping absolute" />
                        <div className="w-3 h-3 rounded-full bg-[#25D366] relative" />
                      </div>
                      <span className="text-xs text-[#25D366]">Aguardando selecao do dispositivo no dialogo do sistema...</span>
                    </motion.div>
                  )}
                </div>
              )}
                      ...
                      return (
                        ...
                        >
                          <div className="p-2 rounded-lg bg-[#25D366]/10">
                            <IconComp className="h-4 w-4 text-[#25D366]" />
                          </div>
                          ...
                          {alreadyPaired ? (
                            ...
                            <Button
                              ...
                              className="gap-1.5 h-8 text-[11px] bg-[#25D366] hover:bg-[#1fb855] text-white rounded-lg"
                            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full h-11 rounded-xl bg-white/[0.03] border border-white/[0.08] text-white text-sm px-3 outline-none focus:border-[#25D366]/30"
                  >
              ...
              <div className="flex justify-end gap-3 mt-4">
                ...
                <Button
                  ...
                  className="bg-[#25D366] hover:bg-[#1fb855] text-white rounded-xl"
                >
                  ...
                  <SpotlightCard className="p-6 space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      <div className={cn(
                        ...
                        d.bleConnected
                          ? 'border-[#25D366]/30 bg-[#25D366]/10 shadow-[0_0_20px_-5px_rgba(37,211,102,0.2)]'
                          : 'border-white/[0.06]'
                      )} style={!d.bleConnected ? { backgroundColor: d.color + '10' } : undefined}>
                        <IconComp className={cn('h-5 w-5', d.bleConnected ? 'text-[#25D366]' : '')} style={!d.bleConnected ? { color: d.color } : undefined} strokeWidth={1.5} />
                      </div>
                      <div className="flex-1 min-w-0">
                      ...
                      {d.bleDeviceId ? (
                        d.bleConnected ? (
                          ...
                          <Button
                            ...
                            className="flex-1 text-[11px] gap-1.5 border-[#25D366]/20 text-[#25D366]/70 hover:text-[#25D366] hover:bg-[#25D366]/[0.06] rounded-xl"
                          >
