                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand/10">
                      <Bluetooth className="h-6 w-6 text-brand" />
                    </div>
                    <motion.div
                      className="absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full bg-brand border-2 border-[#0D1321]"
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="bg-brand/15 text-brand border border-brand/20 text-[10px]">
                  ...
                  <motion.div key={i} {...fadeInUp}>
                    <SpotlightCard className="p-5 h-full">
                      <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-3">
                          <Badge className="h-7 w-7 rounded-full bg-brand/10 text-brand border border-brand/20 flex items-center justify-center text-xs font-bold shrink-0">
                            {i + 1}
                          </Badge>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <Shield className={cn(
                          ...
                          localConfig.sos_enabled ? 'text-brand' : 'text-white/20'
                        )} />
                      </motion.div>
                      <div>
                        <div className="flex items-center gap-2">
                      ...
                      >
                        {isActive && (
                          <motion.div
                            ...
                            className="absolute inset-0 rounded-2xl border-2 border-brand/50"
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="border-t border-white/[0.06] pt-5 space-y-5">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-brand text-xs font-mono font-semibold">
                        ...
                        <Slider
                          ...
                          max={300}
                          step={10}
                          className="[&_[role=slider]]:bg-brand [&_[role=slider]]:border-brand [&>span>span]:bg-brand"
                        />
                    ...
                    <div className="pt-2">
                      <Button
                        ...
                        className="w-full sm:w-auto bg-brand hover:bg-brand/90 text-black font-semibold"
                      >
                        {isSavingConfig ? (
                          <>
