...
const orbs = [
  { size: 300, x: '10%', y: '20%', color: '37,211,102', a: 0.08, blur: 80, dur: 20 },
  { size: 200, x: '70%', y: '10%', color: '59,130,246', a: 0.06, blur: 60, dur: 25 },
  { size: 250, x: '80%', y: '60%', color: '139,92,246', a: 0.05, blur: 70, dur: 22 },
  { size: 180, x: '30%', y: '70%', color: '16,185,129', a: 0.06, blur: 50, dur: 18 },
  { size: 120, x: '50%', y: '40%', color: '37,211,102', a: 0.04, blur: 40, dur: 15 },
]
