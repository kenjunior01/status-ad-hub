  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="mt-1 flex items-center gap-1.5 rounded-xl bg-[#25D366]/10 px-4 py-2 text-xs font-semibold text-[#25D366] transition-colors hover:bg-[#25D366]/20"
      >
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        contact.is_primary
          ? 'border-[#25D366]/30 shadow-[0_0_16px_rgba(37,211,102,0.08)]'
          : 'border-white/[0.06]',
    ...
    >
      ...
      {contact.is_primary && (
        <motion.span
          className="pointer-events-none absolute -inset-px rounded-2xl border-2 border-[#25D366]/20"
      ...
      <div className="relative flex flex-col items-center gap-2">
        ...
        >
          {firstLetter}
          {contact.is_primary && (
            <Star className="absolute -right-0.5 -top-0.5 h-3.5 w-3.5 fill-[#25D366] text-[#25D366]" />
          )}
        </div>
        ...
        <div className="flex gap-1.5">
          <motion.button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#25D366]/10 text-[#25D366] transition-colors hover:bg-[#25D366]/20"
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div className="mb-3 flex items-center gap-2">
        <Shield className="h-4 w-4 text-[#25D366]/60" />
