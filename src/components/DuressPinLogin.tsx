  ...
  const inputCls = (hasError: boolean) =>
    `h-11 w-full rounded-xl border ${
      hasError
        ...
        : 'border-white/[0.08] focus-visible:ring-brand/30 focus-visible:border-brand/30'
            ...
            >
              <div
                className={`flex h-28 w-28 items-center justify-center rounded-3xl border backdrop-blur-md shadow-[0_0_60px_-15px_rgba(212,175,55,0.15)] transition-all duration-200 ${
                  tapFeedback
                    ? 'border-brand/50 bg-brand/[0.12]'
                    : 'border-brand/20 bg-brand/[0.06]'
                }`}
              >
                <Shield
                  className={`h-14 w-14 text-brand transition-transform duration-150 ${
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12 relative">
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-5">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="text-xs text-brand/70 transition hover:text-brand"
                >
                  Esqueceu a senha?
                </button>
              </div>
          ...
          >
            ...
            <a
              href="/ativar"
              className="font-medium text-brand/70 transition hover:text-brand"
            >
              Activar Dispositivo
            </a>
          </motion.p>
