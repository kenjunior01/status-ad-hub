  ...
  private renderError() {
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        >
          <button onClick={this.handleReset} className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-brand hover:bg-brand-dark text-white font-semibold text-sm transition-colors">
        ...
        >
          <button onClick={this.handleCopy} className="flex items-center gap-1.5 text-[11px] text-white/20 hover:text-white/40 transition-colors">
            {this.state.copied
              ? <><Check className="h-3 w-3 text-brand" /> Copiado</>
