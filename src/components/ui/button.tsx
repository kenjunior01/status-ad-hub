  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        safe: "bg-safe text-white shadow-md shadow-safe/20 hover:bg-safe/90 hover:shadow-lg hover:shadow-safe/30 active:scale-[0.98]",
        danger: "bg-danger text-white shadow-md shadow-danger/20 hover:bg-danger/90 animate-emergency-pulse",
        glass: "backdrop-blur-xl bg-background/60 border border-border/50 hover:bg-background/80",
      },
      size: {
